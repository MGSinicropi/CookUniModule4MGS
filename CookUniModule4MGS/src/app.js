...
window.msgs = []; // holds all the notification messages that are generated based on user interaction
window.msgCounter = 0;
...
window.db = new Kinvey('kid_SJjMMFbqd', '86927bc9d3f14ae5a8b14edeb2c75c69');
